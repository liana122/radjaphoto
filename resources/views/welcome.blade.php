...
<head>
    ...
    <link href="{{url('frontend/css/icomoon.css')}}" rel="stylesheet">
...
<body class="homepage"  style="background-image: url(frontend/images/slider/image.jpeg)">
                ...
                <div class="row">
                    {{-- <div class="col-sm-6 col-xs-12">
                        <div class="top-number">
                            <p><i class="fa fa-phone-square text-white"></i> +0123 456 70 90</p>
                        </div>
                    </div> --}}
                    {{-- <div class="col-sm-6 col-xs-12">
                        <div class="social">
        ...
        <nav class="navbar navbar-inverse" role="banner">
                ...
                <div class="collapse navbar-collapse navbar-right">
					<!-- <ul class="nav navbar-nav"> -->
                        ...
                        <a href="{{ route('login') }}" class="btn-primary" type="submit">Log in</a>
                        <a href="{{ route('register') }}" class="btn-primary" type="submit">Register</a>
    ...
    {{--<section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(frontend/images/slider/image.jpeg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                ...
                <!-- <div class="item" style="background-image: url(frontend/images/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row">0
                            <div class="col-md-7">
                                <div class="carousel-content">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('frontend/images/portfolio/item-1.png')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="{{url('frontend/images/portfolio/item-1.png')}}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('frontend/images/portfolio/item-2.png')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="{{url('frontend/images/portfolio/item-2.png')}}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('frontend/images/portfolio/item-3.png')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="{{url('frontend/images/portfolio/item-3.png')}}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('frontend/images/portfolio/item-4.png')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="{{url('frontend/images/portfolio/item-4.')}}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('frontend/images/portfolio/item-5.png')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="{{url('frontend/images/portfolio/item-5.png')}}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="{{url('frontend/images/portfolio/item-6.png')}}" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="{{url('frontend/images/portfolio/item-6.png')}}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap fadeInDown">
                        <div class="pull-left">
                            <img class="img-responsive" src="{{url('frontend/images/services/ux.svg')}}">
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap fadeInDown">
                        <div class="pull-left">
                            <img class="img-responsive" src="{{url('frontend/images/services/web.svg')}}">
                        </div>
                        <div class="media-body">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap fadeInDown">
                        <div class="pull-left">
                            <img class="img-responsive" src="{{url('frontend/images/services/motion.svg')}}">
                        </div>
                        <div class="media-body">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap fadeInDown">
                        <div class="pull-left">
                            <img class="img-responsive" src="{{url('frontend/images/services/mobile-ui.svg')}}">
                        </div>
                        <div class="media-body">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap fadeInDown">
                        <div class="pull-left">
                            <img class="img-responsive" src="{{url('frontend/images/services/web-app.svg')}}">
                        </div>
                        <div class="media-body">
                            ...
                            <div class="parrent media-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade" id="tab1">
                                        <div class="media">
                                            <div class="pull-left">
                                                <img class="img-responsive" src="{{url('frontend/images/tab2.png')}}">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <div class="tab-pane fade active in text-right" id="tab2">
                                        <div class="video-box">
                                            <img src="{{url('frontend/images/tab-video-bg.png')}}" alt="video">
        ...
        <div class="container">
            ...
            <div class="testimonial-slider owl-carousel">
                <div class="single-slide">
                    <div class="slide-img">
                        <img src="{{url('frontend/images/client1.jpg')}}" alt="">
                    </div>
                    <div class="content">
                        <img src="{{url('frontend/images/review.png')}}" alt="">
                ...
                <div class="single-slide">
                    <div class="slide-img">
                        <img src="{{url('frontend/images/client2.jpg')}}" alt="">
                    </div>
                    <div class="content">
                        <img src="{{url('frontend/images/review.png')}}" alt="">
                        <p>If you are looking at blank cassettes on the web, you may be very confused at the difference in price.</p>
                ...
                <div class="single-slide">
                    <div class="slide-img">
                        <img src="{{url('frontend/images/client3.jpg')}}" alt="">
                    </div>
                    <div class="content">
                        <img src="{{url('frontend/images/review.png')}}" alt="">
                        <p>If you are looking at blank cassettes on the web, you may be very confused at the difference in price.</p>
